...
app.on('ready', function onReady() {
  ...
  // See https://github.com/felixrieseberg/ember-electron/issues/340
  if (process.versions.electron === '2.0.0-beta.1') {
    console.log('[DEBUG] Delaying start to circumvent race condition in electron v2.0.0-beta.1');
